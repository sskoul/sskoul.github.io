...
* [<em>Learning to Remove Cuts in Integer Linear Programming</em>](https://sskoul.github.io/files/7075_Learning_to_Remove_Cuts_i.pdf): P. Puigdemont$^\star$, <span style="color:blue;">S. Skoulakis$^\star$, </span>G. Chrysos and V. Cevher, **ICML 2024**.

* [<em>Imitation Learning in Discounted Linear MDPs without exploration assumptions</em>](https://sskoul.github.io/files/1255_Imitation_Learning_in_Dis.pdf): L. Viano$^\star$, <span style="color:blue;">S. Skoulakis, </span>and V. Cevher, **ICML 2024**.

* [<em>Polynomial Convergence of Bandit No-Regret Dynamics in Congestion Games</em>](https://sskoul.github.io/files/2401.09628v1.pdf): L. Dadi$^\star$, I. Panageas$^\star$, <span style="color:blue;"> S. Skoulakis$^\star$, </span>L. Viano and V. Cevher, **WINE 2024**.
